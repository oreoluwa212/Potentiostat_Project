        ...
        <div className="flex relative h-full">
          ...
          <div className="-5 w-full flex flex-col  items-center pt-5 gap-8">
            <div className="flex lgss:flex-row flex-col gap-5 justify-between items-baseline w-3/5">
              ...
              />
              <Link
                className="text-white bg-primary py-2 px-6 lgss:w-[20%]  inline-flex justify-between  items-center"
                to={"/new-client"}
              >
                <button className=" inline-flex justify-between  items-center w-full">
                  <FaPlus /> New Client
                </button>
              </Link>
            </div>
